...
newblock.textContent = "Block 1";
document.body.appendChild(newblock);
const cloneblock = newblock.cloneNode(true);
cloneblock.textContent = "Clone Block 1 to Block 2";
...
const ulItem = document.getElementById("menu");
for (const Item of array) {
    const item = document.createElement("li");
    item.textContent = "Block 1";
